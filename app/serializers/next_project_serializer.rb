...
class NextProjectSerializer < ActiveModel::Serializer
  attributes :isprivate, :private, :user_id, :created_at, :category_name, :inspiringrate, :choosethebest, :sharetoken,
             :presenterquestion, :id, :title, :description, :purpose, :category_id, :parentcategory_id, :review_count,
             :new_review_count, :category_name, :total_score, :project_score, :relation_id, :artcategory_id
